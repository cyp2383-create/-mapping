...
## 热度分规则(严格遵守)
- 分数基于JD高频技能数据中的实际出现频次,最高频给100分,其他的按比例折算
- 例: AI出现18次→100分, 产品出现12次→67分(12/18×100), 运营出现3次→17分(3/18×100)
- 差距必须体现: 18次和12次差6次=分数差约33分,不能编成接近的分数
- 排名不能错: 频次高的分数必须高于频次低的
- 每个skill给出category: "通用能力"/"专业技能"/"工具技术"
